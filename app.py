...
# Ekrana sığma için küçültme
st.markdown("<style> .stApp { max-width: 100%; padding: 0.8rem 1rem; } h1 { font-size: 1.95rem !important; } </style>", unsafe_allow_html=True)
